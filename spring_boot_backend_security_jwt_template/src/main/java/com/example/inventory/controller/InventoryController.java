...
public class InventoryController {
	...
	public ResponseEntity<?> updateInventory(@RequestBody Inventory item, @PathVariable String id){
	...
	public ResponseEntity<Inventory> deleteInventory(@PathVariable String id){
